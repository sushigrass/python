...
def main():
    ...
    #flowers['petal_length'][flowers['species']=='virginica']#to get only that species
    #adding glyphs
    ...
    f.circle(x=flowers["petal_length"][flowers['species']=='setosa'], y=flowers["petal_width"][flowers['species']=='setosa'],
             size=flowers['sepal_width'][flowers['species']=='setosa']*4, fill_alpha=0.2, color=flowers['color'][flowers['species']=='setosa'],line_dash=[5,3],legend='setosa')

    f.circle(x=flowers["petal_length"][flowers['species']=='versicolor'], y=flowers["petal_width"][flowers['species']=='versicolor'],
             size=flowers['sepal_width'][flowers['species']=='versicolor']*4, fill_alpha=0.2, color=flowers['color'][flowers['species']=='versicolor'],line_dash=[5,3],legend='versicolor')

    f.circle(x=flowers["petal_length"][flowers['species']=='virginica'], y=flowers["petal_width"][flowers['species']=='virginica'],
             size=flowers['sepal_width'][flowers['species']=='virginica']*4, fill_alpha=0.2, color=flowers['color'][flowers['species']=='virginica'],line_dash=[5,3],legend='virginica')

    f.legend.location = 'top_left' #or can specify pixel coordinates
